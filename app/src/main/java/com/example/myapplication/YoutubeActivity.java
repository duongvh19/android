...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    static final String GOOGLE_API_KEY = "AIzaSyAV-UoxU-yzk95gEqCmSrOR8RNKqv1aKwU";
    static final String YOUTUBE_VIDEO_ID = "ElpitAfkRS4";
    static String YOUTUBE_PLAYLIST = "PLXtTjtWmQhg1SsviTmKkWO5n0a_-T0bnD";
...
//        button1.setLayoutParams(new ConstraintLayout.LayoutParams(300,300));
//        button1.setText("Button Add");
//        layout.addView(button1);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean wasRestored) {
        ...
        //wasRestored nguoi dung co tiep tuc tu doan dang phat hay ko
